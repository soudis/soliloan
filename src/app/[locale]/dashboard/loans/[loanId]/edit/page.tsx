    ...
    ? (() => {
        const baseData = {
          ...
          altInterestMethod: loan.altInterestMethod
            ? (loan.altInterestMethod as z.infer<typeof interestMethodEnum>)
            : null,
        ...
        switch (loan.terminationType) {
          case "ENDDATE":
            if (!loan.endDate) {
              throw new Error(
                "End date is required for ENDDATE termination type"
              );
            }
            return {
              ...baseData,
          ...
          default:
            throw new Error(
              `Invalid termination type: ${loan.terminationType}`
            );
        }
      })()
    : undefined;
