...
export function SaveViewDialog({ viewType, onSave, isLoading = false }: SaveViewDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button variant="outline" size="icon" className="h-8 w-8" title={t('saveView.title')}>
