            ...
            <table className="w-full border-collapse">
              <thead>
                <tr className="border-b">
                  ...
                  <th className="py-2 px-4 text-right font-medium">
                    {t("yearlyTable.deposits")}
                  </th>
                  <th className="py-2 px-4 text-right font-medium">
                    {t("yearlyTable.interest")}
                  </th>
                  <th className="py-2 px-4 text-right font-medium">
                    {t("yearlyTable.withdrawals")}
                  </th>
                  <th className="py-2 px-4 text-right font-medium">
                    {t("yearlyTable.notReclaimed")}
                  </th>
                  <th className="py-2 px-4 text-right font-medium">
                    {t("yearlyTable.interestPaid")}
                  </th>
                  <th className="py-2 px-4 text-right font-medium">
                    {t("yearlyTable.end")}
                  </th>
                ...
                {filteredData.map((yearData) => (
                  ...
                  >
                    ...
                    <td className="py-2 px-4 text-right text-red-600">
                      {formatCurrency(yearData.withdrawals)}
                    </td>
                    <td className="py-2 px-4 text-right text-red-600">
                      {formatCurrency(yearData.notReclaimed)}
                    </td>
                    <td className="py-2 px-4 text-right text-red-600">
                      {formatCurrency(yearData.interestPaid)}
                    </td>
                    <td className="py-2 px-4 text-right">
                      {formatCurrency(yearData.end)}
                    </td>
                  </tr>
                ))}
              </tbody>
